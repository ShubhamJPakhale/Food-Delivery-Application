...
import { github_link, Github_url, linkdin_url } from "../config";

const Footer = (props)=>{
    return(
        <div className="flex justify-between pl-3  sticky  bottom-0 z-[100] bg-pink-50 shadow-lg sm:bg-blue-50 md:bg-yellow-50">
            <div>
                <a href="/"> 
                <img
            ...
            <div className="py-3 font-medium ">© {props.date.getFullYear()} Food Junction by <b className="text-purple-700">Shubham Pakhale</b> </div>

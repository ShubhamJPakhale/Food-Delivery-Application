    ...
    return(
        <div className="flex bg-slate-100">
            <div className="ml-5 mt-2 mb-2">
                <img src={ITEM_IMG_CDN_URL + resinfo?.cloudinaryImageId} alt={resinfo?.name} className="h-[150px] w-[200px]"/>
            </div>
            <div className="ml-[75px] mt-3">
                ...
                <div className="font-light text-base">{resinfo?.cuisines?.join(",")}</div>
                ...
                <div style={
                    ...
                    <span className="m-1"><IoStar /></span>
                    <span className="m-1 ">{resinfo?.avgRatingString}</span>
                </div>
                <div className="m-2"><VscCircleFilled/></div>

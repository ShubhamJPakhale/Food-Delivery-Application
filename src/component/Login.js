  ...
  return (
    ...
    >
      {(formik) => {
        ...
        return (
          <div className="rounded shadow-slate-200 width-full pt-[40px] pb-[40px] bg-slate-100">
            <div className="relative z-1 rounded max-w-[400px] m-6 p-4 bg-blue-100 self-center mx-[490px]">
